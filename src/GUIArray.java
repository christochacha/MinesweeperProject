...
public class GUIArray {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < 14; i++) {
            for (int n = 0; n < 18; n++) {
                // sets the values of row and col so that they can't be changed in the making of
                // each button
                final int row = i;
                final int col = n;
                ...
                ActionListener listener = e -> {
                    ...
                    switch (guiFinalArr[row][col]) {
                        ...
                        // call to find zero with the button 2d array, and the button index as
                        // parameters
                        case ("0"):
                            if (buttonRightClicked[row][col]) {
                                updateLabel(--bombsFlagged);
                            }
    ...
    public static void findZero(JButton[][] buttons, boolean[][] buttonClicked, String[][] guiFinalArr, int row,
            int col) {
